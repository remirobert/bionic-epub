...
# Used for fixation levels other than 3.
FIXATION_BOUNDARIES: dict[int, list[int]] = {
    1: [0, 4, 12, 17, 24, 29, 35, 42, 48],
    2: [1, 2, 7, 10, 13, 14, 19, 22, 25, 28, 31, 34, 37, 40, 43, 46, 49],
    3: [
        # Retained for reference / invalid-fallback documentation only.
        # fixation_length(..., 3) uses WEBSITE_DEFAULT_FIXATION_RATIO instead.
